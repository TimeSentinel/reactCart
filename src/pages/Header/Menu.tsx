...
export default function Menu() {
    return (
        <div className="Menu relative inline-block text-left">
            ...
            <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md
            bg-white shadow-lg ring-1 ring-black/5 transition focus:outline-none data-[closed]:scale-95
